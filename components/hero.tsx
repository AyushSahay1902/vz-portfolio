        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Button variant="ghost" size="icon" asChild>
              <Link href="https://github.com/AyushSahay1902" target="_blank" rel="noopener noreferrer">
                <Github className="h-5 w-5" />
                <span className="sr-only">GitHub</span>
              </Link>
            </Button>
            <Button variant="ghost" size="icon" asChild>
              <Link href="https://www.linkedin.com/in/ayushsahay-developer/" target="_blank" rel="noopener noreferrer">
                <Linkedin className="h-5 w-5" />
                <span className="sr-only">LinkedIn</span>
              </Link>
            </Button>
            <Button variant="ghost" size="icon" asChild>
              <Link href="https://x.com/AyushSahay19" target="_blank" rel="noopener noreferrer">
